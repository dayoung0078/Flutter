...
* 2. style : TextStyle 객체를 사용하여 글자 크기, 색상, 두께, 기울임체 등을 설정
* 3. textAlign : 정렬
* 4. overflow : 텍스트가 지정된 공간을 넘칠 경우 처리 방법을 설정한다.
* 5. MaxLines : 텍스트의 최대 줄 수를 설정. 이 속성 사용ㅎ면 텍스트가 여러 줄로 나뉘도록 할 수 있다.
* */
...
class TextWidget extends StatelessWidget{
  ...
  * 이를 통해 flutter의 상태를 유지하고 위젯 트리를 효율적으로 업데이트를 할 수 있게 된다.
